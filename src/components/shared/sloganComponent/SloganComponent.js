                    ...
                    <div className='flex flex-col w-full min-h-72 max-h-auto text-start md:text-left mx-auto'>
                        <div className="flex items-center mb-2">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <a className="text-textProduct text-base md:text-base font-oswald">Descubre la perfección en cada detalle de nuestras piezas únicas.</a>
                            </div>
                        </div>
                        <div className="flex items-center mb-2">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <a className="text-textProduct text-base mb-2 md:text-base font-oswald">Joyería diseñada para acompañarte en cada etapa de la vida.</a>
                            </div>
                        </div>
                        <div className="flex items-center mb-2">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <a className="text-textProduct text-base md:text-base font-oswald">Diseños que capturan miradas y dejan una impresión duradera.</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='flex flex-col w-full h-72 text-start md:text-left mx-auto'>
                        <div className="flex items-center mb-2">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <a className="text-textProduct text-base md:text-base font-oswald">Encuentra tu propia expresión de sofisticación y gracia.</a>
                            </div>
                        </div>
                        <div className="flex items-center mb-2">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <a className="text-textProduct text-base mb-2 md:text-base font-oswald">Piezas elaboradas con los más altos estándares de excelencia.</a>
                            </div>
                        </div>
                        <div className="flex items-center mb-2">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <a className="text-textProduct text-base md:text-base font-oswald">Diseños únicos que reflejan tu individualidad y buen gusto.</a>
                            </div>
                        </div>
                    </div>
                </div>
