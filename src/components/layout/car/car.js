...
import CarList from '../../shared/carList/carList';
import Cupon from '../../shared/cupponAdvisor/cupon';
import Bill from '../../shared/billComponent/bill';
...
function Car() {
  ...
  return (
    <div className='min-h-screen w-full flex flex-wrap flex-col justify-center items-center py-10'>
      { !proccedCheck ? (
        <div className='w-full md:w-4/5 lg:w-5/6 lg:h-4/5 bg-cardColor p-4 rounded-xl shadow-lg'>
        ...
        <div className='w-full md:w-4/5 lg:w-5/6 lg:h-4/5 bg-cardColor p-4 rounded-xl shadow-lg' style={{height: '100vh'}}>
          <Checkout/>
        </div>
      )}
    </div>
